...
echo $sql_main="SELECT * FROM live where live_id='".$live_id."'" ;
$live_main_coll = mysqli_query($connection,$sql_main );
$live_data=mysqli_fetch_array($live_main_coll);


$images[]='https://' . $_SERVER['SERVER_NAME'].'/assets/global/live_thumb/'.$live_id.'.jpg';
...
<meta http-equiv="pragma" content="no-cache" />
	...
	<title>Play Live | Happy Watch 99</title>
...
<meta property="og:description" content="<?php echo $live_data['title']; ?>" />
<meta property="og:url" content=https://happywatch99.com/livetv.php?live_id=<?php echo $live_id ?>" />
...
//$view_count=$this->db->get_where('live_view', array('live_id'=>$live_id))->num_rows();

$sql_1="SELECT * FROM live_view where live_id='".$live_id."'" ;
$view_coll = mysqli_query($connection,$sql_1 );

$view_count=mysqli_num_rows($view_coll);
	...
	<div class="content">
		...
		<div class="col-lg-3 col-sm-4 .col-md-3 div_background">
		  ...
		  <img src="https://happywatch99.com/assets/global/<?php echo $bar_thumb;?>" 
		   ...
		   <div class="div_right myNewDivHeight" >
		        <strong><?php echo $live_data['title'] ?></strong>
		    </div>   
...
<script>
        ...
        window.location = "https://happywatch99.com/index.php?home/playbroadcast/1268";

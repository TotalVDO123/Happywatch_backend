<form method="post" action="<?php echo base_url();?>index.php?admin/channel_create" enctype="multipart/form-data">
	<div class="row">
	    <div class="col-6">
	        <div class="card">
	            <div class="card-body">
		...
		<div class="col-6">
			<div class="row">
				<div class="form-group col-6">
					<input type="submit" class="btn btn-success col-12" value="Create channel">
				</div>
				<div class="col-6">

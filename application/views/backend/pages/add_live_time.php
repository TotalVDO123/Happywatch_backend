...
<div class="card">
    ...
    <div class="row">
        <div class="col-md-6">
            <?php 
                ?>
				<form method="post" action="<?php echo base_url();?>index.php?admin/update_live_time/" enctype="multipart/form-data">
        ...
        <button type="button" onclick="window.location.href='<?php echo base_url() ?>index.php?admin/live_list/' "  class="btn btn-primary pull-right waves-effect"> <span class="btn-label"></span>Back </button>

...
<div class="card">
    ...
    <div class="row">
        <div class="col-md-6">
            <?php 
                ?>
				<form method="post" action="<?php echo base_url();?>index.php?admin/save_videos_time/" enctype="multipart/form-data">
            ...
            <div class="card">
                ...
                <tr>
                <td>
		            <button type="button" onclick="window.location.href='<?php echo base_url() ?>index.php?admin/movie_list/' "  class="btn btn-primary pull-right waves-effect"> <span class="btn-label"></span>Back </button>    

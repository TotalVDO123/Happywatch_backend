...
<?php
	$live_details	=	$this->db->get_where('live' , array('live_id' => $live_id))->result_array();
	foreach ($live_details as $row):
	?>
...
<style>
	...
	top: 0;
	left: 0;
	background-image: url(<?php echo $this->crud_model->get_poster_url('live' , $row['live_id']);?>);
	width: 100%;
	height: 100%;
	opacity : 0.2;
	z-index: -1;
			...
			<div class="col-lg-12">
				...
				<!-- Video player generator starts -->
						...
						<?php elseif (get_video_extension($row['url']) == 'mp4'):?>
							...
							<link rel="stylesheet" href="<?php echo base_url();?>assets/global/plyr/plyr.css">
							<video poster="<?php echo $this->crud_model->get_thumb_url('live' , $row['live_id']);?>" id="player" playsinline controls>
				...
				<script>
					jwplayer("video_player_div").setup({
						...
						"image": "<?php echo $this->crud_model->get_poster_url('live' , $row['live_id']);?>",
						"width": "100%",
						aspectratio: "16:9",
						listbar: {
						  position: 'right',
...
<div class="container" style="margin-top: 30px;">
	<div class="row">
		<div class="col-lg-8">
			<div class="row">
				<div class="col-lg-3">
					<img src="<?php echo $this->crud_model->get_thumb_url('live' , $row['live_id']);?>" style="height: 60px; margin:20px;" />
				</div>
				<div class="col-lg-9">
					<!-- VIDEO TITLE -->
					<h3>
		...
		<script>
			...
			// Show the add/delete wishlist button on page load
			   $( document ).ready(function() {
			    ...
			    mylist_exist_status = "<?php echo $this->crud_model->get_mylist_exist_status('live' , $row['live_id']);?>";
		...
		<div class="col-lg-4">
			...
			<div style="margin-top: 10px;">
				...
				<a href="<?php echo base_url();?>index.php?browse/live/<?php echo $row['genre_id'];?>">
				...
				<div id="myTabContent" class="tab-content">
					...
					<div class="tab-pane  " id="more">
						...
						<div class="content">
							<div class="grid">
								<?php
									$live = $this->crud_model->get_live($row['genre_id'] , 10, 0);
									foreach ($live as $row)
									{
										$title	=	$row['title'];

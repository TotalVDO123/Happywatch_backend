	...
	<div class="content">
		<div class="grid">
			<?php 
				...
				{
					$title	=	$this->db->get_where('live' , array('live_id' => $live[$i]))->row()->title;
					$link	=	base_url().'index.php?browse/playlive/' . $live[$i];
					$thumb	=	$this->crud_model->get_thumb_url('live' , $live[$i]);
					include 'thumb.php';
				}

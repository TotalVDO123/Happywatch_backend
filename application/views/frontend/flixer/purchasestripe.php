...
<html lang="en">
    ...
    <body>
        ...
        <form method="post" action="<?php echo base_url();?>index.php?payment/stripe_payment/<?php echo $plan_id;?>">
			...
			<p style="text-align:center;"><img src="<?php echo base_url();?>assets/global/logo1.png"/></p>
            <br>
            <br>
            <br>
          <!-- <p style="text-align:center"><label>Stripe authorized payment gateway</label></p>-->
			
            <label>
                <div id="card-element" class="field is-empty"></div>
                <span><span>Credit / Debit card</span></span>
            </label>
            <button style="background-color: #9d22af;"class="btn btn-default " type="submit">
                Pay 
            </button>
            <div class="outcome">

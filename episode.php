...
$sql_main="SELECT * FROM  episode where episode_id='".$episode_id."'" ;
$movie_main_coll = mysqli_query($connection,$sql_main );
$episode_data=mysqli_fetch_array($movie_main_coll);


$images[]='https://' . $_SERVER['SERVER_NAME'].'/assets/global/episode_thumb/'.$episode_id.'.jpg';
...
<meta http-equiv="pragma" content="no-cache" />
	...
	<title>Play Movie | Happy Watch 99</title>
...
<meta property="og:description" content="<?php echo $episode_data['title']; ?>" />
<meta property="og:url" content=https://happywatch99.com/movie.php?movie_id=<?php echo $movie_id ?>" />
...
//$sql_1="SELECT * FROM movie_view where movie_id='".$live_id."'" ;
	...
	<div class="content">
		...
		<div class="col-lg-3 col-sm-4 .col-md-3 div_background">
		  ...
		  <img src="https://happywatch99.com/assets/global/<?php echo $bar_thumb;?>" 
		   ...
		   <div class="div_right myNewDivHeight" >
		        <strong><?php echo $episode_data['title'] ?></strong>
		    </div>   

...
$sql_main="SELECT * FROM  movie where movie_id='".$movie_id."'" ;
$movie_main_coll = mysqli_query($connection,$sql_main );
$movie_data=mysqli_fetch_array($movie_main_coll);


$images[]='https://' . $_SERVER['SERVER_NAME'].'/assets/global/movie_thumb/'.$movie_id.'.jpg';
...
<meta property="og:description" content="<?php echo $movie_data['title']; ?>" />
...
$sql_1="SELECT * FROM movie_view where movie_id='".$movie_id."'" ;
	...
	<div class="content">
		...
		<div class="col-lg-3 col-sm-4 .col-md-3 div_background">
		  ...
		  <img src="https://happywatch99.com/assets/global/<?php echo $bar_thumb;?>" 
		   ...
		   <div class="div_right myNewDivHeight" >
		        <strong><?php echo $movie_data['title'] ?></strong>
		    </div>   
